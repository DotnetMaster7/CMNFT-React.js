...
class ConnectWithCMDesktop extends Component {  
  render() {
    return(

<div id="Parent-ConnectWithCMDesktop">

<div id="parent" className="container-fluid">
<p id = "p-blue-60" align="center"><strong>Connect with CM</strong></p>
...
export default ConnectWithCMDesktop;